...
However, this simplicity should not be mistaken for a lack of functionality: Python is far more capable than most languages; it can be used for everything from system administration to web development (as in the case of this system) to game design.
